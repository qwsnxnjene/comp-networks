...
class Ui_DialogAdd(object):
    def setupUi(self, DialogAdd):
        ...
        self.pushButton.setGeometry(QtCore.QRect(180, 740, 171, 51))
        self.pushButton.setObjectName("pushButton")
        self.labelInput_4 = QtWidgets.QLabel(parent=DialogAdd)
        self.labelInput_4.setEnabled(False)
        self.labelInput_4.setGeometry(QtCore.QRect(10, 490, 281, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelInput_4.setFont(font)
        self.labelInput_4.setObjectName("labelInput_4")
        self.tableChannels = QtWidgets.QTableWidget(parent=DialogAdd)
        self.tableChannels.setEnabled(False)
        self.tableChannels.setGeometry(QtCore.QRect(10, 520, 431, 201))
    ...
    def retranslateUi(self, DialogAdd):
        ...
        self.labelInput_4.setText(_translate("DialogAdd", "Матрица каналов(0 - канал есть, 1 - нет)"))
